...
namespace MyLeasing.Web.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckRoles();
            var manager = await CheckUserAsync("1010", "Daniel", "Ardila", "ardiladm@hotmail.com", "311 419 06 55", "Calle Luna Calle Sol", "Manager");
            var owner = await CheckUserAsync("2020", "Daniel", "Ardila", "danielardila180515@correo.itm.edu.co", "311 419 06 55", "Calle Luna Calle Sol", "Owner");
            var lessee = await CheckUserAsync("3030", "Juan", "Zuluaga", "dardila@bancolombia.com.co", "350 634 2747", "Calle Luna Calle Sol", "Lessee");
